...
-- Modified to work as a lit module
...
-- this section originally had the commands being exported to the global namespace
-- this is not very Lit-like, so this feature has been removed
